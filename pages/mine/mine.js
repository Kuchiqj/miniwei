...
var openid = wx.getStorageSync("openid");//官方文档获取用户openid
Page({
  data: {
  ...
  //         //发送请求
  //         wx.request({
  //           url:getApp().globalData.userInterfaceUrl+'record/'+res.code, //接口地址
  //           method: 'GET',
  //           header: {
  ...
  //         //发送信息给服务器获得用户信息
  //         wx.request({
  //           url:getApp().globalData.userInterfaceUrl+'login',
  //           dataType: "json",
  //           method: "POST",
  //           data: data,
  //           success: function(res) {
